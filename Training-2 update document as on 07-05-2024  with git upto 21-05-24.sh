...
scp apache-maven-3.9.7-bin.tar.gz apache-tomcat-9.0.89.tar.gz jenkins.war root@192.168.254.145:/opt 
...
firewall-cmd --permanent --add-port=8080/tc... by Cloud Gen (Guest)
Cloud Gen (Guest)
10:57 AM
...
https://github.com/Devops9AM/Markatlas-Project
